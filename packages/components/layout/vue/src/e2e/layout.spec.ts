...
test.describe('Layout Vue E2E Tests', () => {
  describe('基础渲染测试', () => {
    test('应该渲染默认布局', async ({ page }) => {
      await page.goto('/iframe.html?id=vue-layout--default');
    ...
    test('应该渲染 Footer', async ({ page }) => {
      await page.goto('/iframe.html?id=vue-layout--full-layout');
      await page.waitForLoadState('networkidle');
  ...
  describe('组件状态测试', () => {
    test('应该切换 Sidebar 折叠状态', async ({ page }) => {
      await page.goto('/iframe.html?id=vue-layout--with-collapsed-sidebar');
      await page.waitForLoadState('networkidle');
    ...
    test('应该在无 Header 时正确渲染', async ({ page }) => {
      await page.goto('/iframe.html?id=vue-layout--without-header');
      await page.waitForLoadState('networkidle');
    ...
    test('应该在无 Sidebar 时正确渲染', async ({ page }) => {
      await page.goto('/iframe.html?id=vue-layout--without-sidebar');
      await page.waitForLoadState('networkidle');
